...
public class TileEntityWorkbenchCarpenter
    extends TileEntityWorkbenchBasicBase {

  private static final int TEXT_SHADOW_DARK_COLOR = new Color(85, 69, 43).getRGB();
  private static final int TEXT_SHADOW_LIGHT_COLOR = new Color(188, 152, 98).getRGB();
  private static final BlockWorkbenchBasic.EnumType TYPE = BlockWorkbenchBasic.EnumType.CARPENTER;
  private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(
      ModPWCustom.MOD_ID,
      "textures/gui/workbench_basic_carpenter.png"
  );

  public TileEntityWorkbenchCarpenter() {
