...
public class TileEntityWorkbenchBlacksmith
  ...
  private static final int TEXT_SHADOW_DARK_COLOR = new Color(55, 55, 55).getRGB();
  private static final int TEXT_SHADOW_LIGHT_COLOR = new Color(162, 162, 162).getRGB();
