...
public class BlockLogPileAsh
    extends Block {

  public static final String NAME = "log_pile_ash";

  public static final int MIN_DROP_COUNT = 6;
  public static final int MAX_DROP_COUNT = 9;

  public BlockLogPileAsh() {
  ...
  public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
    ...
    for (int i = 0; i < MAX_DROP_COUNT - count; i++) {
      result.add(new ItemStack(ModuleCharcoal.Items.WOOD_ASH, 1, 0));
    }
