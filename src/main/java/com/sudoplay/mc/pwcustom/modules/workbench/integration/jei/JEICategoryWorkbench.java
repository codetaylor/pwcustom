...
public class JEICategoryWorkbench
  ...
  public JEICategoryWorkbench(String uid, String titleTranslateKey, IDrawable background) {
  ...
  public void setRecipe(
    ...
    List<ItemStack> tools = ((JEIRecipeWrapperWorkbench) recipeWrapper).getTools();
