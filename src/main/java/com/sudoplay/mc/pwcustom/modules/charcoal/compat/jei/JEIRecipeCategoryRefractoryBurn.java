...
public class JEIRecipeCategoryRefractoryBurn
  ...
  public JEIRecipeCategoryRefractoryBurn(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleCharcoal.MOD_ID + ".jei.category.burn.refractory");
  }
  ...
  public void setRecipe(
    ...
    int capacity = ModuleCharcoalConfig.REFRACTORY.ACTIVE_PILE_MAX_FLUID_CAPACITY;
