...
public class ModuleFluids {
  ...
  private static <T extends Block & IFluidBlock> Fluid createFluid(
    ...
    String texturePrefix = ModuleCharcoal.MOD_ID + ":" + "blocks/fluid_";
  ...
  @Mod.EventBusSubscriber(modid = ModuleCharcoal.MOD_ID)
  public static class RegistrationHandler {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
      ...
      for (final IFluidBlock fluidBlock : MOD_FLUID_BLOCK_LIST) {
        ...
        block.setRegistryName(ModuleCharcoal.MOD_ID, "fluid." + fluidBlock.getFluid().getName());
        block.setUnlocalizedName(fluidBlock.getFluid().getUnlocalizedName());
        block.setCreativeTab(ModuleCharcoal.CREATIVE_TAB);
  ...
  @Mod.EventBusSubscriber(value = Side.CLIENT, modid = ModuleCharcoal.MOD_ID)
