package com.sudoplay.mc.ctpwcustom;

import com.sudoplay.mc.ctpwcustom.integration.CraftTweakerPlugin;
import com.sudoplay.mc.ctpwcustom.proxy.ProxyCommon;
...
public class ModPWCustom {
  ...
  public static final String MOD_ID = "ctpwcustom";
  public static final String VERSION = "@@VERSION@@";
  public static final String NAME = "CT PlanesWalker Modpack Custom Content";
  public static final String PROXY_CLIENT = "com.sudoplay.mc.ctpwcustom.proxy.ProxyClient";
  public static final String PROXY_SERVER = "com.sudoplay.mc.ctpwcustom.proxy.ProxyServer";
