package com.sudoplay.mc.ctpwcustom.block;

import com.sudoplay.mc.ctpwcustom.Constants;
import com.sudoplay.mc.ctpwcustom.ModPWCustom;
import com.sudoplay.mc.ctpwcustom.init.ModBlocks;
import com.sudoplay.mc.ctpwcustom.util.PortalFrameUtil;
import com.sudoplay.mc.ctpwcustom.util.Props;
import com.sudoplay.mc.ctpwcustom.world.TeleporterCustom;
...
public class BlockPortalDarklands
  ...
  public boolean trySpawnPortal(World worldIn, BlockPos pos) {
    ...
    PortalFrameUtil portalFrameUtil = new PortalFrameUtil(
        ...
        pos,
        EnumFacing.Axis.X,
        ModBlocks.PORTAL_FRAME.getStateFromMeta(PORTAL_FRAME_META),
        this
    );
  ...
  public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
    ...
    if (!entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn.isNonBoss()) {
      ...
      if (entityIn instanceof EntityPlayerMP) {
        ...
        } else if (player.dimension != Constants.DIMENSION_ID_DARKLANDS) {
          // player is not in the dimension

          int dimension = Constants.DIMENSION_ID_DARKLANDS;
